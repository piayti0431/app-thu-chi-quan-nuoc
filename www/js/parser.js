...
export const DEFAULT_QUICK_ITEMS = [
  ...
  { id: "tra_tac", name: "Trà tắc", category: "Trà tắc", price: 12000, costPrice: 7000, voiceName: "trà tắc", voiceUnit: "ly" },
...
function detectCategory(normalized, type, product) {
  ...
  if (normalized.includes("tac") && normalized.includes("duong")) return "Mua tắc và đường";
